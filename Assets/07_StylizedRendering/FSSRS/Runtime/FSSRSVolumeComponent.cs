...
namespace FlowState.Rendering
{
    ...
    public sealed class FSSRSVolumeComponent : VolumeComponent, IPostProcessComponent
    {
        ...
        public ClampedFloatParameter grainIntensity = new(0.12f, 0f, 1f);
        ...
        public bool IsActive() => enabledEffect.value && outlineIntensity.value + grainIntensity.value +
            halftoneIntensity.value + hatchIntensity.value + paletteInfluence.value > 0.001f;
